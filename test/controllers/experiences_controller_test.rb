...
class ExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post :create, experience: { date: @experience.date, notes: @experience.notes, place: @experience.place, title: @experience.title }
    end
  ...
  test "should update experience" do
    patch :update, id: @experience, experience: { date: @experience.date, notes: @experience.notes, place: @experience.place, title: @experience.title }
    assert_redirected_to experience_path(assigns(:experience))
  end
